...
const blogPosts = [
  ...
  //  NEW HIGH-PRIORITY SEO POSTS 
  {
    ...
    imageAlt: 'AI SEO course - learning how to rank on Google and in AI search engines like ChatGPT and Perplexity',
    externalUrl: null,
  },
  {
  ...
  {
    slug: 'free-data-driven-seo-course',
    title: 'Free Data-Driven SEO Course: What You Get and How to Start',
    excerpt: 'Most free SEO courses teach tactics without context. The KnowHow course teaches you how to use your own data to decide what to do next. Here is exactly what you get and how to start.',
    category: 'SEO',
    author: 'Pip Seymour',
    date: 'April 21, 2026',
    dateISO: '2026-04-21',
  ...
  {
    slug: 'google-ads-campaign-types-2026',
    title: 'Google Ads Campaign Types: The Complete 2026 Guide',
    excerpt: 'Choosing the wrong campaign type is the single most common reason Google Ads campaigns fail. This guide covers all 7 campaign types in 2026, what has changed, and exactly when to use each one.',
    category: 'Google Ads',
    author: 'Pip Seymour',
    date: 'April 28, 2026',
    dateISO: '2026-04-28',
  ...
  {
    slug: 'seo-coaching-for-marketing-teams',
    title: 'SEO Coaching for Marketing Teams: How It Works and What to Expect',
    excerpt: 'When the whole marketing team understands the SEO strategy, the results compound. Here is how team SEO coaching works at KnowHow and what your team can expect to get out of it.',
    category: 'Coaching',
    author: 'Pip Seymour',
    date: 'May 5, 2026',
    dateISO: '2026-05-05',
  ...
  //  CLUSTER POSTS (supporting the pillar) 
  {
    ...
    title: 'How to Set Up Google Search Console (Step-by-Step Guide for 2026)',
    excerpt: 'Google Search Console is one of the most important free tools for any business with a website. It shows you exactly how your site appears in Google search - which keywords bring people to you, which pages Google has indexed, and whether there are any technical problems. This guide walks you through the full setup.',
    category: 'SEO',
    author: 'Pip Seymour',
    date: 'March 2, 2026',
    dateISO: '2026-03-02',
    ...
    isPillar: false,
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80',
    imageAlt: 'Google Search Console dashboard showing search performance data including clicks, impressions, and average position for a business website',
    externalUrl: null,
  },
  {
    slug: 'keyword-research-keyword-clusters',
    title: 'How to Do Keyword Research Using Keyword Clusters (2026 Guide)',
    excerpt: 'Most keyword research guides teach you how to find keywords. This one teaches you what to do with them. Keyword clustering is the strategy that turns a list of keywords into a content plan - and it is the reason some businesses dominate entire topic areas in Google while others rank for nothing.',
    category: 'SEO',
    author: 'Pip Seymour',
    date: 'March 2, 2026',
    dateISO: '2026-03-02',
    ...
    imageAlt: 'Keyword research data on a laptop screen showing search volume and keyword clusters for SEO content planning',
    externalUrl: null,
  },
  {
    slug: 'ga4-explained-for-business-owners',
    title: 'GA4 Explained for Business Owners (Plain Language Guide for 2026)',
    excerpt: 'Google Analytics 4 explained in plain language for business owners. Learn what GA4 tracks, what the key reports mean, and how to use it to make better marketing decisions - without needing to be a data analyst.',
    category: 'Analytics',
    author: 'Pip Seymour',
    date: 'March 2, 2026',
    dateISO: '2026-03-02',
    ...
    isPillar: false,
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80',
    imageAlt: 'Google Analytics 4 dashboard showing website traffic data, user behaviour reports, and conversion metrics for a business owner',
    externalUrl: null,
  },
  //  EXISTING POSTS 
  {
  ...
  },
  {
    ...
    isPillar: false,
    image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80',
    imageAlt: 'Google Ads fundamentals - understanding the Google Ads auction, keywords, and bidding for beginners',
    externalUrl: null,
  },
  {
...
export default function Blog() {
  useSEO({
    ...
    ogType: "website",
    ogImage: "https://d2xsxph8kpxj0f.cloudfront.net/310419663028389518/RfGSqQsChvaaheLhAWutyi/og-blog_fe9e6640.png",
  });
                ...
                >
                  ...
                  <div className="max-w-3xl mx-auto prose prose-gray" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">
                      ...
                      <a href="/blog/google-analytics-4-setup-guide" className="text-[#318599] hover:underline">GA4 setup guide</a>{' '}
                    ...
                    <p className="text-gray-600 leading-relaxed mb-6">
                      ...
                      <a href="/url-redirects-everything-you-need-to-know-for-seo" className="text-[#318599] hover:underline">URL redirects and SEO</a>.
                    </p>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                      ...
                      <a href="/ai-seo-guide" className="text-[#318599] hover:underline">Complete Guide to AI SEO</a>.
                    </p>
