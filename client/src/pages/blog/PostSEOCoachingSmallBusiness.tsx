// /blog/seo-coaching-for-small-business
// Design: White/light contemporary, Space Grotesk + DM Sans, amber #E98C28, teal #318599
// Target keyword: "seo coaching for small business"
// Internal links: → /courses/seo, → /pricing, → /about, → /blog/seo-and-analytics-coaching-for-marketers, → /blog/google-ads-coaching-for-small-business, → /blog/data-driven-seo-guide-medium-sized-businesses, → /blog/ai-seo-course
...
<h3 class="wp-block-heading">2. No time to learn everything from scratch</h3>
...
<h2 id="the-highest-priority-seo-fixes-for-small-businesses">The Highest-Priority SEO Fixes for Small Businesses</h2>

<p>If you are a small business doing SEO right now, here are the most important things to check first:</p>

<h3 class="wp-block-heading">1. Set Up and Check Google Search Console</h3>
...
<p>If you are also running Google Ads alongside your SEO, see the companion post on <a href="/blog/google-ads-coaching-for-small-business" style="color:#318599;text-decoration:underline;">Google Ads coaching for small business</a>. And if you are a marketing professional rather than a business owner, the <a href="/blog/seo-and-analytics-coaching-for-marketers" style="color:#318599;text-decoration:underline;">SEO and analytics coaching for marketers</a> post covers what to look for in a coach at a more advanced level.</p>
...
export default function PostSEOCoachingSmallBusiness() {
  useEffect(() => {
    ...
    script.text = JSON.stringify({
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://knowhowmarketinglab.com/blog/seo-coaching-for-small-business"
      },
      "keywords": ["seo coaching for small business", "seo help small business", "seo training small business", "small business seo coaching", "seo coach small business"]
    });
    ...
    breadcrumbScript.text = JSON.stringify({
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "SEO Coaching for Small Business", "item": "https://knowhowmarketinglab.com/blog/seo-coaching-for-small-business" }
      ]
    });
    ...
    if (canonical) canonical.setAttribute('href', 'https://knowhowmarketinglab.com/blog/seo-coaching-for-small-business');
      ...
      <main className="pt-28 pb-20">
        <article className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <nav className="flex items-center gap-2 text-sm text-slate-500 mb-8">
            ...
            <span>/</span>
            <span className="text-slate-700 truncate">SEO Coaching for Small Business</span>
          </nav>
          ...
          <div className="relative h-64 md:h-96 overflow-hidden rounded-2xl mb-10">
            <img
              ...
              alt="Small business owner reviewing their website SEO data on a laptop with Google Search Console open"
          ...
          <nav className="bg-slate-50 border border-slate-200 rounded-xl p-6 mb-10">
            ...
            <ol className="list-decimal list-inside space-y-1.5">
              <li><a href="#what-seo-coaching-for-small-business-actually-means" className="text-[#318599] hover:underline text-sm">What SEO Coaching for Small Business Actually Means</a></li>
              <li><a href="#why-small-businesses-struggle-with-seo" className="text-[#318599] hover:underline text-sm">Why Small Businesses Struggle with SEO</a></li>
              <li><a href="#what-to-look-for-in-seo-coaching-for-small-business" className="text-[#318599] hover:underline text-sm">What to Look For in SEO Coaching</a></li>
              <li><a href="#how-much-does-seo-coaching-cost-for-small-businesses" className="text-[#318599] hover:underline text-sm">How Much Does SEO Coaching Cost?</a></li>
              <li><a href="#the-highest-priority-seo-fixes-for-small-businesses" className="text-[#318599] hover:underline text-sm">The Highest-Priority SEO Fixes for Small Businesses</a></li>
              <li><a href="#how-knowhow-marketing-lab-helps-small-businesses-with-seo" className="text-[#318599] hover:underline text-sm">How KnowHow Marketing Lab Helps Small Businesses</a></li>
          ...
          <div className="mt-12 pt-8 border-t border-slate-200">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Link href="/blog/google-ads-coaching-for-small-business" className="block p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                <span className="text-xs font-semibold text-[#E98C28] uppercase tracking-wide">Coaching</span>
                <p className="text-sm font-semibold text-slate-800 mt-1">Google Ads Coaching for Small Business</p>
              </Link>
            </div>
          </div>
