...
export default function PostTheUltimateGuideToGoogleAdsBiddingStrategies() {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://knowhowmarketinglab.com/the-ultimate-guide-to-google-ads-bidding-strategies/"
  }
});
    ...
    if (canonical) canonical.setAttribute('href', 'https://knowhowmarketinglab.com/the-ultimate-guide-to-google-ads-bidding-strategies/');
