      ...
      <main className="pt-28 pb-20">
        <article className="container max-w-3xl" itemScope itemType="https://schema.org/Article">
          ...
          <p className="text-lg text-gray-600 mb-6 leading-relaxed" style={{ fontFamily: 'DM Sans, sans-serif' }}>
            Most free SEO courses teach you tactics — write a blog post, add keywords, build links. The KnowHow course teaches you something different: how to use your own data to decide what to do next. Here is exactly what you get and how to start.
          </p>
          ...
          <div className="prose prose-slate prose-lg max-w-none prose-headings:font-bold prose-headings:text-slate-900 prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-slate-700 prose-p:leading-relaxed prose-a:text-[#318599] prose-a:no-underline hover:prose-a:underline prose-strong:text-slate-900 prose-ul:text-slate-700 prose-ol:text-slate-700 prose-li:mb-1 prose-blockquote:border-l-[#318599] prose-blockquote:text-slate-600" style={{ fontFamily: 'DM Sans, sans-serif' }}>
            ...
            <p>The problem with most free SEO courses is not the quality of the information — it is that they teach tactics without context. You learn how to write a title tag, how to build a backlink, how to do keyword research. But you never learn how to look at your own data and decide which of these things to do first, for your specific website, right now.</p>
            <p>The result is that people finish a course, try a few things, don't see results in 30 days, and give up. The issue was never the tactics. The issue was not having a data-driven process to follow.</p>
            ...
            <p>The course is designed for marketing managers and business owners at medium-sized businesses who are responsible for their company's SEO but don't have a dedicated SEO team. You don't need a technical background. You do need a website with Google Search Console set up (or the willingness to set it up in Module 1).</p>
            ...
            <p>Most students start with the free course, implement the basics, and upgrade to The Lab when they want faster results and direct coaching support.</p>
          </div>
